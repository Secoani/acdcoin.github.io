function setLanguage(lang) {
    ...
    document.querySelector(".container h1").textContent =
        content[lang].downloadTitle;
    document.querySelector(".container p").textContent =
        content[lang].downloadDesc;
    document.querySelector(".windows-btn-download").textContent =
        content[lang].windowsButton;
    document.querySelector(".mac-btn-download").textContent =
        content[lang].macButton;
