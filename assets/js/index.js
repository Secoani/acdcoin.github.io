...
function setLanguage(lang) {
    ...
    document.querySelector(".slogan-area h1").textContent =
        content[lang].slogan;
    document.querySelector(".slogan-area button").textContent =
        content[lang].downloadButton;
    document.querySelector(".description h1").textContent =
        content[lang].descriptionTitle;
    document.querySelector(".description p").textContent =
        content[lang].descriptionText;
    document.querySelector(".description button").textContent =
        content[lang].learnMoreButton;
