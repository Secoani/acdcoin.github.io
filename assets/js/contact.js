function setLanguage(lang) {
    ...
    document.querySelector(".main-content p:first-of-type").textContent =
        content[lang].contactDesc;
    document.querySelector(".main-content p.ceoLabel strong").textContent =
        content[lang].ceoTitle;
    document.querySelector(".main-content p.EmailLabel strong").textContent =
        content[lang].emailLabel;
    document.querySelector(".main-content p.PhoneLabel strong").textContent =
        content[lang].phoneLabel;
    document.querySelector(".main-content p.AddressLabel strong").textContent =
        content[lang].addressLabel;
    document.querySelector(".main-content p.gmLabel strong").textContent =
        content[lang].gmTitle;
    document.querySelector(".main-content p.gmEmailLabel strong").textContent =
        content[lang].emailLabel;
    document.querySelector(".main-content p.gmPhoneLabel strong").textContent =
        content[lang].phoneLabel;
    document.querySelector(
        ".main-content p.gmAddressLabel strong"
    ).textContent = content[lang].addressLabel;
