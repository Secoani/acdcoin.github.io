function setLanguage(lang) {
    ...
    document.querySelector(".mining.container h1").textContent =
        content[lang].miningTitle;
    document.querySelector(".mining.container p").textContent =
        content[lang].miningDesc;
    document.querySelector(".content.container h1:first-of-type").textContent =
        content[lang].whyMiningTitle;
    document.querySelector(".content.container p:first-of-type").textContent =
        content[lang].whyMiningDesc;
    document.querySelector(".content.container h1:last-of-type").textContent =
        content[lang].howToStartTitle;
    document.querySelector(".content.container p:nth-of-type(2)").textContent =
        content[lang].howToStartDesc;
