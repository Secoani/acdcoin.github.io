function setLanguage(lang) {
    ...
    document.querySelector(".aboutText p:first-of-type").textContent =
        content[lang].aboutText;
    document.querySelector(".aboutText h2:nth-of-type(1)").textContent =
        content[lang].visionTitle;
    document.querySelector(".aboutText p:nth-of-type(2)").textContent =
        content[lang].visionText;
    document.querySelector(".aboutText h2:nth-of-type(2)").textContent =
        content[lang].missionTitle;
    document.querySelector(".aboutText p:nth-of-type(3)").textContent =
