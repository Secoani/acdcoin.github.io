...
const content = {
    tr: {
        ...
        senderLabel: 'Gönderen Adresi <span class="tooltip">? <span class="tooltip-text">ACDcoin gönderen adresini girin.</span></span>',
        receiverLabel: 'Alıcı Adresi <span class="tooltip">? <span class="tooltip-text">Alıcının adresini girin.</span></span>',
        amountLabel: 'Miktar (ACDcoin) <span class="tooltip">? <span class="tooltip-text">Göndermek istediğiniz ACDcoin miktarını belirtin.</span></span>',
    ...
    en: {
        ...
        senderLabel: 'Sender Address <span class="tooltip">? <span class="tooltip-text">Enter the address sending the ACDcoin.</span></span>',
        receiverLabel: 'Receiver Address <span class="tooltip">? <span class="tooltip-text">Enter the recipient\'s address.</span></span>',
        amountLabel: 'Amount (ACDcoin) <span class="tooltip">? <span class="tooltip-text">Specify the amount of ACDcoin to send.</span></span>',
